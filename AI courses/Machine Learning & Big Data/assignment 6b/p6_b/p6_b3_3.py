...
# Define the complex neural network model with L2 regularization
...
# Initialize the complex model with L2 regularization
model_complex_regularized = ComplexModelRegularized()

# Define loss function and optimizer with L2 regularization
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(model_complex_regularized.parameters(), lr=0.001, weight_decay=0.1)  # L2 regularization
...
# Evaluate the complex model with L2 regularization on cross-validation data
with torch.no_grad():
...
print(f'Complex Model with L2 Regularization - Cross-validation accuracy: {cv_accuracy:.2%}')
...
# Plot decision boundaries of the complex model with L2 regularization on the training data
plt.figure(figsize=(8, 6))
plot_decision_boundary(model_complex_regularized, X_train.numpy(), y_train.numpy(), 'Complex Model with L2 Regularization - Training Data')

# Plot decision boundaries of the complex model with L2 regularization on the cross-validation data
plt.figure(figsize=(8, 6))
plot_decision_boundary(model_complex_regularized, X_cv.numpy(), y_cv.numpy(), 'Complex Model with L2 Regularization - Cross-Validation Data')
